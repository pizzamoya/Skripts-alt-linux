...
echo 192.168.200.1/28 > /etc/net/ifaces/enp0s3/ipv4address
echo 2000:200::1/124 > /etc/net/ifaces/enp0s3/ipv6address
echo default via 192.168.200.14 > /etc/net/ifaces/enp0s3/ipv4route
echo default via 2000:200::f > /etc/net/ifaces/enp0s3/ipv6route  
